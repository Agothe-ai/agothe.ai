  ...
  return (
    <ServicePage
      ...
      problemItems={[
        ...
        'Wearable design rarely considers the wearer\u2019s cognitive and emotional state',
      ...
      solutionDescription="Each piece integrates mathematical pattern structures with sensory-optimized materials. The result is clothing that doesn\u2019t just look different \u2014 it feels architecturally coherent with the wearer\u2019s constraint field."
      features={[
      ...
      faq={[
        ...
        { question: 'Is this purely conceptual?', answer: 'No. We\u2019re developing physical garments. The mathematical framework informs real design and material decisions.' },
